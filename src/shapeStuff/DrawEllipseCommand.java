...
public class DrawEllipseCommand implements IShapeAll{
	...
	public DrawEllipseCommand (PaintCanvasBase base, Point downPoint, Point upPoint, String shadeType,
	...
	public boolean equals(IShapeAll shape) {
		if (!(shape instanceof DrawEllipseCommand)) return false;
	...
	public void outline()
	{
        ...
        graphics2d.drawOval	((int) startPoint.getX(),
        					 (int) startPoint.getY(),
